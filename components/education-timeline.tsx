      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          {education.map((edu, index) => (
            ...
            >
              <div className="relative bg-linear-to-br from-card via-card to-muted/5 rounded-3xl border border-border/50 overflow-hidden shadow-lg hover:shadow-2xl hover:border-primary/40 transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="relative p-7 sm:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      {/* Institution Logo */}
                      {edu.instLogo && (
                        <div className="relative w-14 h-14 sm:w-16 sm:h-16 shrink-0 bg-background rounded-2xl border border-border/50 p-2.5 shadow-md ring-1 ring-border/10 group-hover:shadow-lg transition-shadow duration-300">
                          <Image
                            src={edu.instLogo}
                            alt={edu.instName}
                            fill
                      ...
                      <div className="flex-1 min-w-0">
                        {edu.instUrl ? (
                          ...
                          >
                            ...
                            <ExternalLink className="w-4 h-4 shrink-0 opacity-60 group-hover/link:opacity-100 transition-opacity duration-300" />
                          </a>
                        ) : (
